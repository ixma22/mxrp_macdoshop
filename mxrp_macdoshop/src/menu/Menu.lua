...
function RageUI.CreateMenu(Title, Subtitle, X, Y, TextureDictionary, TextureName, R, G, B, A)
    ...
    Menu.Index = 1
    Menu.Sprite = { Dictionary = TextureDictionary or "mcdo_banner", Texture = TextureName or "banner_mcdo", Color = { R = R, G = G, B = B, A = A } }
    Menu.Rectangle = nil
...
function RageUI.Menus:EditSpriteColor(color)
    if self.Sprite.Dictionary == "mcdo_banner" then
...
function RageUI.Menus:SetSpriteBanner(TextureDictionary, Texture)
    self.Sprite = { Dictionary = TextureDictionary or "mcdo_banner", Texture = Texture or "banner_mcdo" }
    self.Rectangle = nil
end
